...
{
    public partial class Cert_P1024_600_BCC_UC_ChargingMain_Include_Emergency : UserControl, IUC_Channel
    {
        protected int mChannelIndex = 0;
        public Cert_P1024_600_BCC_UC_ChargingMain_Include_Emergency(int channelIndex) : this()
        {
        ...
        public Cert_P1024_600_BCC_UC_ChargingMain_Include_Emergency()
        {
            InitializeComponent();
